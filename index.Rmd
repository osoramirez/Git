...
Para obtener diferentes tipos de fuentes, utiliza el símbolo **#** y un espacio posterior al incoo de cada título o subtitulo que requieras utilizar.
...
Para crear color en texto se debe generar un "spam (lapso)" previo y cerrarlo de la misma manera
